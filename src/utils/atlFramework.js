...
// The staff directory used to live here as a hardcoded constant. It is gone:
// teachers are rows in the `users` table now, added through the admin roster,
// so real names never sit in source control.
